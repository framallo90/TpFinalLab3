...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        GestionConsecionaria gestionConsecionaria = new GestionConsecionaria(compradorView, compradorRepository,
                compradorController, empleadosView, empleadosRepository, empleadosController, metodoView,
                metodoController, automovilView, automovilRepository, automovilController, ventaView, ventaRepository,
                ventaController);
